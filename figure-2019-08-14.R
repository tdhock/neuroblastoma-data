...
gg <- ggplot()+
  ...
  facet_grid(cv.type + test.fold ~ selection, labeller=label_both)+
  geom_line(aes(
...
png("figure-2019-08-14-all.png", 15, 6, units="in", res=100)
print(dl)
dev.off()

some.stats <- both.stats[grepl("GP", model) | model=="unreg_linear_2"]
...
png("figure-2019-08-14-L1reg.png", 15, 6, units="in", res=100)
print(gg)
dev.off()
...
png("figure-2019-08-14.png", 15, 6, units="in", res=100)
print(gg2)
dev.off()
